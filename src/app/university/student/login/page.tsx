...
export default function StudentLoginPage() {
  ...
  useEffect(() => {
    if (user) {
      localStorage.setItem('tradenova:universityRole', 'student')
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    if (mode === 'signup') {
      const result = await signUpWithEmail(email, password, 'student', fullName || undefined)
      if (result.success) {
      ...
      <div className="w-full max-w-md">
        ...
        <GlassCard className="p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-blue-500/20 mx-auto mb-4 flex items-center justify-center">
